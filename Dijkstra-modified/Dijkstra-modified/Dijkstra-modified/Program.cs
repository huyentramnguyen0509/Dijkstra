...
namespace DijkstraTest2
{
    ...
    class SetUpGraph
    {
        ...
        public void FindPaths(string source, string last,TextBox tbKM, TextBox tbPath)
        {
            ...
            int v = Convert.ToInt32(last);
            {
                if (v != s)
                {
                    ...
                    {
                        FindPath(s, v,tbKM, tbPath);
                    }
                }
            }
        }

        public void FindPath(int s, int v, TextBox tbKM, TextBox tbPath)
        {
            int i, u;
            int[] path = new int[n];
            int km = 0;
